...
from .episode_cache import EpisodeCacheDatabase
from .episode_override import EpisodeOverrideDatabase
...
class Database:
    ...
    def __init__(self, engine=None):
        ...
        self.episode_override = EpisodeOverrideDatabase(self.session)
        self.episode_cache = EpisodeCacheDatabase(self.session)
